...
const FOOD_SHEET: SpriteSheet = {
  ...
  sprites: [
    ...
    { name: 'food_hotdog', row: 0, col: 0, offsetY: -12, scale: 0.68 },
    { name: 'food_burger', row: 0, col: 1, offsetY: -12, scale: 0.68 },
    { name: 'food_fries', row: 0, col: 2, offsetY: -12, scale: 0.65 },
    { name: 'food_corndog', row: 0, col: 3, offsetY: -12, scale: 0.65 },
    { name: 'food_pretzel', row: 0, col: 4, offsetY: -12, scale: 0.65 },
    // Row 1: Sweet Treats
    { name: 'food_icecream', row: 1, col: 0, offsetY: -12, scale: 0.68 },
    { name: 'food_cotton_candy', row: 1, col: 1, offsetY: -12, scale: 0.65 },
    { name: 'food_candy_apple', row: 1, col: 2, offsetY: -12, scale: 0.65 },
    { name: 'food_churros', row: 1, col: 3, offsetY: -12, scale: 0.65 },
    { name: 'food_funnel_cake', row: 1, col: 4, offsetY: -12, scale: 0.68 },
    // Row 2: Drinks
    { name: 'drink_soda', row: 2, col: 0, offsetY: -12, scale: 0.65 },
    { name: 'drink_lemonade', row: 2, col: 1, offsetY: -12, scale: 0.68 },
    { name: 'drink_smoothie', row: 2, col: 2, offsetY: -12, scale: 0.65 },
    { name: 'drink_coffee', row: 2, col: 3, offsetY: -12, scale: 0.65 },
    { name: 'drink_slushie', row: 2, col: 4, offsetY: -12, scale: 0.65 },
    // Row 3: Snacks
    { name: 'snack_popcorn', row: 3, col: 0, offsetY: -12, scale: 0.68 },
    { name: 'snack_nachos', row: 3, col: 1, offsetY: -12, scale: 0.65 },
    { name: 'snack_pizza', row: 3, col: 2, offsetY: -14, scale: 0.7 },
    { name: 'snack_cookies', row: 3, col: 3, offsetY: -12, scale: 0.65 },
    { name: 'snack_donuts', row: 3, col: 4, offsetY: -12, scale: 0.65 },
    // Row 4: International
    { name: 'food_tacos', row: 4, col: 0, offsetY: -12, scale: 0.68 },
    { name: 'food_noodles', row: 4, col: 1, offsetY: -12, scale: 0.68 },
    { name: 'food_kebab', row: 4, col: 2, offsetY: -12, scale: 0.65 },
    { name: 'food_crepes', row: 4, col: 3, offsetY: -12, scale: 0.65 },
    { name: 'food_waffles', row: 4, col: 4, offsetY: -12, scale: 0.65 },
    // Row 5: Themed Carts (slightly larger)
    { name: 'cart_pirate', row: 5, col: 0, offsetY: -14, scale: 0.72 },
    { name: 'cart_space', row: 5, col: 1, offsetY: -14, scale: 0.72 },
    { name: 'cart_medieval', row: 5, col: 2, offsetY: -14, scale: 0.72 },
    { name: 'cart_western', row: 5, col: 3, offsetY: -14, scale: 0.72 },
    { name: 'cart_tropical', row: 5, col: 4, offsetY: -14, scale: 0.72 },
  ],
};
...
const FOUNTAINS_SHEET: SpriteSheet = {
  ...
  sprites: [
    ...
    { name: 'fountain_large_1', row: 2, col: 0, offsetY: -22, scale: 0.85 },
    { name: 'fountain_large_2', row: 2, col: 1, offsetY: -22, scale: 0.85 },
    { name: 'fountain_large_3', row: 2, col: 2, offsetY: -22, scale: 0.85 },
    { name: 'fountain_large_4', row: 2, col: 3, offsetX: -2, offsetY: -22, scale: 0.82 },
    { name: 'fountain_large_5', row: 2, col: 4, offsetY: -22, scale: 0.85 },
    // Row 3: Ponds
    { name: 'pond_small', row: 3, col: 0, offsetY: -5, scale: 0.55 },
    { name: 'pond_medium', row: 3, col: 1, offsetY: -5, scale: 0.65 },
    { name: 'pond_large', row: 3, col: 2, offsetY: -5, scale: 0.75 },
    ...
    { name: 'dancing_fountain', row: 5, col: 4, offsetY: -12, scale: 0.7 },
  ],
};
...
const RIDES_SMALL_SHEET: SpriteSheet = {
  ...
  rows: 6,
  sprites: [
    // Row 0: Kiddie rides (small rides)
    { name: 'ride_kiddie_coaster', row: 0, col: 0, offsetY: -18, scale: 0.75 },
    { name: 'ride_kiddie_train', row: 0, col: 1, offsetY: -16, scale: 0.72 },
    ...
    // Row 4: Water rides
    { name: 'ride_bumper_boats', row: 4, col: 0, offsetY: -16, scale: 0.75 },
    { name: 'ride_paddle_boats', row: 4, col: 1, offsetY: -16, scale: 0.72 },
...
const RIDES_LARGE_SHEET: SpriteSheet = {
  ...
  rows: 6,
  sprites: [
    // Row 0: Ferris wheels (very large)
    { name: 'ride_ferris_classic', row: 0, col: 0, offsetY: -45, scale: 0.95 },
    { name: 'ride_ferris_modern', row: 0, col: 1, offsetY: -45, scale: 0.95 },
    { name: 'ride_ferris_observation', row: 0, col: 2, offsetY: -50, scale: 1.0 },
    { name: 'ride_ferris_double', row: 0, col: 3, offsetY: -48, scale: 0.98 },
    { name: 'ride_ferris_led', row: 0, col: 4, offsetY: -50, scale: 1.0 },
    // Row 1: Drop rides (very large/tall)
    { name: 'ride_drop_tower', row: 1, col: 0, offsetY: -55, scale: 1.0 },
    { name: 'ride_space_shot', row: 1, col: 1, offsetY: -58, scale: 1.02 },
    { name: 'ride_observation_tower', row: 1, col: 2, offsetY: -58, scale: 1.02 },
    { name: 'ride_sky_swing', row: 1, col: 3, offsetY: -45, scale: 0.95 },
    { name: 'ride_star_flyer', row: 1, col: 4, offsetY: -50, scale: 0.98 },
    // Row 2: Swing rides (large)
    { name: 'ride_swing_ride', row: 2, col: 0, offsetY: -32, scale: 0.88 },
    { name: 'ride_wave_swinger', row: 2, col: 1, offsetY: -35, scale: 0.9 },
    { name: 'ride_flying_scooters', row: 2, col: 2, offsetY: -32, scale: 0.88 },
    { name: 'ride_enterprise', row: 2, col: 3, offsetY: -35, scale: 0.92 },
    { name: 'ride_loop_o_plane', row: 2, col: 4, offsetY: -35, scale: 0.9 },
    // Row 3: Thrill rides (large)
    { name: 'ride_top_spin', row: 3, col: 0, offsetY: -35, scale: 0.9 },
    { name: 'ride_frisbee', row: 3, col: 1, offsetY: -38, scale: 0.92 },
    ...
    // Row 5: Shows (large structures)
    { name: 'show_4d', row: 5, col: 0, offsetY: -28, scale: 0.88 },
    { name: 'show_stunt', row: 5, col: 1, offsetY: -30, scale: 0.9 },
    { name: 'show_dolphin', row: 5, col: 2, offsetY: -30, scale: 0.9 },
    { name: 'show_amphitheater', row: 5, col: 3, offsetY: -32, scale: 0.92 },
    { name: 'show_parade_float', row: 5, col: 4, offsetY: -22, scale: 0.85 },
  ],
};
